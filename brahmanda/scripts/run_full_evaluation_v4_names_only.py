...
def main():
    ...
    ap.add_argument("--analogues", required=True,
        help="retrieval_output_v4/per_event")
    ...
    for h in [7, 15, 30]:
        ...
        if not ok:
            failures.append(f"kde_engine_v4.py h={h}")
    ...
    log.info("Next step: diff the new kde_v4_results_h15.csv coverage/CRPS/FEI "
              "numbers against your current paper's Tables 2/4/6 to see "
              "whether the base_quantile fix moved anything.")
