...
def main():
    ...
    latex.append(r"FEI $= $ divergence(benchmark, actual) / divergence(KDE v4, actual);")
    latex.append(r"FEI $> 1$ indicates KDE v4 outperforms the benchmark.")
    latex.append(r"Percentages in parentheses: fraction of events where KDE v4 wins.}")
    ...
    latex.append(r"\multicolumn{6}{l}{\small \textbf{Bold}: FEI $> 1$ (KDE v4 outperforms benchmark).} \\")
